        ...
        <div class="uk-card-body uk-width-4-5 uk-flex uk-flex-between">
          ...
          <div class="uk-width-1-4 uk-flex uk-flex-between uk-flex-middle uk-flex-center">
            <div class="uk-width-3-4 uk-flex uk-flex-column uk-flex-middle">
              <form id="new-amount-form-<?= $cart_item->product_id ?>" method="POST" action="src/Formhandlers/updateAmount.php" style="display: none">
              ...
              <input id="amount-<?= $cart_item->product_id?>" class="uk-form-controls uk-form-width-xsmall uk-text-medium" name="amount" value="<?=$cart_item->amount?>" onchange="ChangeAmount(<?= $cart_item->product_id?>)" type="number" />
            </div>
